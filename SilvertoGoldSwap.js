...
async function main() {
    ...
    const tokenBAddress = "0xC772CA584BDD329713B9eA8298f0Bb2261D4c696";
    const tokenAAddress = "0x554274f68A271E9449ef8B0e7531a9Cc03807006";
    ...
    // Approve TokenExchange to spend user's CryptoSilver tokens
    ...
    console.log(`Swapped ${amountIn.toString()} CryptoSilver for CryptoGold`);
}
